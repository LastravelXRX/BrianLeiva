...
public class MainActivity extends AppCompatActivity {
    ...
    public void BuscarProducto(View view){
        ...
        if (!idProducto.isEmpty()){
            Cursor fila = BaseDatos.rawQuery("Select NombreProducto, CategoriaProducto, CantidadProducto, PrecioProducto,UbicacionProducto from Inventario_Bodega where ID=" + idProducto, null);
            if(fila.moveToFirst()){
    ...
    public void EliminarProducto(View view){
        ...
        if (!IDProducto.isEmpty()){
            ...
            if (Eliminar == 1){
                ...
                Toast.makeText(this, "El producto se elimino correctamente", Toast.LENGTH_LONG).show();
                BaseDatos.close();
